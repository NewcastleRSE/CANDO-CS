...
C_SRCS += \
../ARM.CMSIS.5.5.1/CMSIS/Pack/Example/Device/Source/system_LPC18xx.c 

OBJS += \
./ARM.CMSIS.5.5.1/CMSIS/Pack/Example/Device/Source/system_LPC18xx.o 

C_DEPS += \
./ARM.CMSIS.5.5.1/CMSIS/Pack/Example/Device/Source/system_LPC18xx.d 


# Each subdirectory must supply rules for building sources it contributes
ARM.CMSIS.5.5.1/CMSIS/Pack/Example/Device/Source/%.o: ../ARM.CMSIS.5.5.1/CMSIS/Pack/Example/Device/Source/%.c
	@echo 'Building file: $<'
