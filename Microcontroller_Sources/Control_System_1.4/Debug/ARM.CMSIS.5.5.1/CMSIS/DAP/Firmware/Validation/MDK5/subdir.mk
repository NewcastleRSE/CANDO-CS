...
C_SRCS += \
../ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Validation/MDK5/test.c 

OBJS += \
./ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Validation/MDK5/test.o 

C_DEPS += \
./ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Validation/MDK5/test.d 


# Each subdirectory must supply rules for building sources it contributes
ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Validation/MDK5/%.o: ../ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Validation/MDK5/%.c
	@echo 'Building file: $<'
