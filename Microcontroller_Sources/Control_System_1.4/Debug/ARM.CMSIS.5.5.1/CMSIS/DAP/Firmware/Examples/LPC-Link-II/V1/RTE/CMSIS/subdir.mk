...
C_SRCS += \
../ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Examples/LPC-Link-II/V1/RTE/CMSIS/RTX_Config.c 

OBJS += \
./ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Examples/LPC-Link-II/V1/RTE/CMSIS/RTX_Config.o 

C_DEPS += \
./ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Examples/LPC-Link-II/V1/RTE/CMSIS/RTX_Config.d 


# Each subdirectory must supply rules for building sources it contributes
ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Examples/LPC-Link-II/V1/RTE/CMSIS/%.o: ../ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Examples/LPC-Link-II/V1/RTE/CMSIS/%.c
	@echo 'Building file: $<'
