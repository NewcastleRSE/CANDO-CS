...
C_SRCS += \
../ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Examples/LPC-Link-II/V2/RTE/USB/USBD_Config_0.c 

OBJS += \
./ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Examples/LPC-Link-II/V2/RTE/USB/USBD_Config_0.o 

C_DEPS += \
./ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Examples/LPC-Link-II/V2/RTE/USB/USBD_Config_0.d 


# Each subdirectory must supply rules for building sources it contributes
ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Examples/LPC-Link-II/V2/RTE/USB/%.o: ../ARM.CMSIS.5.5.1/CMSIS/DAP/Firmware/Examples/LPC-Link-II/V2/RTE/USB/%.c
	@echo 'Building file: $<'
