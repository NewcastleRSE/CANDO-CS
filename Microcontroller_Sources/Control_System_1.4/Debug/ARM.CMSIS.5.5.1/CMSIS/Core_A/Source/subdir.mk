...
C_SRCS += \
../ARM.CMSIS.5.5.1/CMSIS/Core_A/Source/irq_ctrl_gic.c 

OBJS += \
./ARM.CMSIS.5.5.1/CMSIS/Core_A/Source/irq_ctrl_gic.o 

C_DEPS += \
./ARM.CMSIS.5.5.1/CMSIS/Core_A/Source/irq_ctrl_gic.d 


# Each subdirectory must supply rules for building sources it contributes
ARM.CMSIS.5.5.1/CMSIS/Core_A/Source/%.o: ../ARM.CMSIS.5.5.1/CMSIS/Core_A/Source/%.c
	@echo 'Building file: $<'
