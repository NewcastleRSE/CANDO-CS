...
C_SRCS += \
../ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/MemPool/main.c 

OBJS += \
./ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/MemPool/main.o 

C_DEPS += \
./ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/MemPool/main.d 


# Each subdirectory must supply rules for building sources it contributes
ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/MemPool/%.o: ../ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/MemPool/%.c
	@echo 'Building file: $<'
