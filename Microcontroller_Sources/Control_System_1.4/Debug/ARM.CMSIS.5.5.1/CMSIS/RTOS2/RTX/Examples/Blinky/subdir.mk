...
C_SRCS += \
../ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/Blinky/Blinky.c 

OBJS += \
./ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/Blinky/Blinky.o 

C_DEPS += \
./ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/Blinky/Blinky.d 


# Each subdirectory must supply rules for building sources it contributes
ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/Blinky/%.o: ../ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/Blinky/%.c
	@echo 'Building file: $<'
