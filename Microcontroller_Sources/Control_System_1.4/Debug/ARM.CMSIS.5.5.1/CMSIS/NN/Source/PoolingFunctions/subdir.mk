...
C_SRCS += \
../ARM.CMSIS.5.5.1/CMSIS/NN/Source/PoolingFunctions/arm_pool_q7_HWC.c 

OBJS += \
./ARM.CMSIS.5.5.1/CMSIS/NN/Source/PoolingFunctions/arm_pool_q7_HWC.o 

C_DEPS += \
./ARM.CMSIS.5.5.1/CMSIS/NN/Source/PoolingFunctions/arm_pool_q7_HWC.d 


# Each subdirectory must supply rules for building sources it contributes
ARM.CMSIS.5.5.1/CMSIS/NN/Source/PoolingFunctions/%.o: ../ARM.CMSIS.5.5.1/CMSIS/NN/Source/PoolingFunctions/%.c
	@echo 'Building file: $<'
