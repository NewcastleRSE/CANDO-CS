...
C_SRCS += \
../ARM.CMSIS.5.5.1/CMSIS/Core/Template/ARMv8-M/main_s.c \
../ARM.CMSIS.5.5.1/CMSIS/Core/Template/ARMv8-M/tz_context.c 

OBJS += \
./ARM.CMSIS.5.5.1/CMSIS/Core/Template/ARMv8-M/main_s.o \
./ARM.CMSIS.5.5.1/CMSIS/Core/Template/ARMv8-M/tz_context.o 

C_DEPS += \
./ARM.CMSIS.5.5.1/CMSIS/Core/Template/ARMv8-M/main_s.d \
./ARM.CMSIS.5.5.1/CMSIS/Core/Template/ARMv8-M/tz_context.d 


# Each subdirectory must supply rules for building sources it contributes
ARM.CMSIS.5.5.1/CMSIS/Core/Template/ARMv8-M/%.o: ../ARM.CMSIS.5.5.1/CMSIS/Core/Template/ARMv8-M/%.c
	@echo 'Building file: $<'
