...
C_SRCS += \
../ARM.CMSIS.5.5.1/CMSIS/RTOS2/Template/cmsis_os1.c 

OBJS += \
./ARM.CMSIS.5.5.1/CMSIS/RTOS2/Template/cmsis_os1.o 

C_DEPS += \
./ARM.CMSIS.5.5.1/CMSIS/RTOS2/Template/cmsis_os1.d 


# Each subdirectory must supply rules for building sources it contributes
ARM.CMSIS.5.5.1/CMSIS/RTOS2/Template/%.o: ../ARM.CMSIS.5.5.1/CMSIS/RTOS2/Template/%.c
	@echo 'Building file: $<'
