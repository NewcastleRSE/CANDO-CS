...
C_SRCS += \
../ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/Migration/Blinky.c 

OBJS += \
./ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/Migration/Blinky.o 

C_DEPS += \
./ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/Migration/Blinky.d 


# Each subdirectory must supply rules for building sources it contributes
ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/Migration/%.o: ../ARM.CMSIS.5.5.1/CMSIS/RTOS2/RTX/Examples/Migration/%.c
	@echo 'Building file: $<'
