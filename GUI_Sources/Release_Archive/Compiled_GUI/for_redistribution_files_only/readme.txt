...
================================
-CANDO_GUI 
-run_CANDO_GUI.sh (shell script for temporarily setting environment variables and 
                   executing the application)
   -to run the shell script, type
   
       ./run_CANDO_GUI.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v98, run the shell script as:
       ...
       ./run_CANDO_GUI.sh /mathworks/home/application/v98
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_CANDO_GUI.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/v98/runtime/glnxa64:MR/v98/bin/glnxa64:MR/v98/sys/os/glnxa64:MR/v98/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_CANDO_GUI.sh 
